...
{
    public class SalesInvoiceModel : PageModel
    {
        private readonly ISalesInvoiceService _salesInvoiceService;
        
        public SalesInvoiceModel(ISalesInvoiceService salesInvoiceService)
        {
        ...
        public List<SalesInvoice> Results { get; set; } = new List<SalesInvoice>();
        ...
        public async Task OnGetAsync()
        {
            ...
            try
            {
                ...
                if (Results.Count == 0)
                {
                    ...
                    {
                        SuccessMessage = "No sales invoices found in the database.";
                    }
                }
            }
            catch (Exception ex)
